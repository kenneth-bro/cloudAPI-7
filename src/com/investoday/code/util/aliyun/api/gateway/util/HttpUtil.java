 ...
 * under the License.
 */
package com.investoday.code.util.aliyun.api.gateway.util;
...
import com.investoday.code.util.aliyun.api.gateway.constant.SystemHeader;
import com.investoday.test.commons.Test11;
...
//        }
        ...
        //使用HttpClient连接池
        HttpResponse response = HttpPool.getResponse(url, headers);
...
//      headers.put(SystemHeader.X_CA_TIMESTAMP, String.valueOf(new Date().getTime())); 
        //headers.put(SystemHeader.X_CA_TIMESTAMP, Test11.getGMT()); //使用格林尼治时间
